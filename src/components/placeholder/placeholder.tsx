      ...
      <div className={classNames({
        ...
        <Dialog>
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuItem onClick={() => handleInsert(placeholder)}>
                ...
                <span className="ml-2">{t("placeholder.insert")}</span>
              </DropdownMenuItem>
              <DialogTrigger asChild>
                <DropdownMenuItem>
                  <InfoIcon size="16" />
                  <span className="ml-2">{t("placeholder.info")}</span>
                </DropdownMenuItem>
              </DialogTrigger>
            </DropdownMenuContent>
          </DropdownMenu>
          <DialogContent className="min-w-[50%]">
            <DialogHeader>
              <DialogTitle>{t("placeholder.info")}</DialogTitle>
              <div
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    <code
                      className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm ">{pathToPlaceholder(placeholder)}</code>
                  </p>
                </div>
              </div>
            </DialogHeader>
